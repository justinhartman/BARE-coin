...
This issue tracker is only for technical issues related to BARE Core.
General BARE questions and/or support requests and are best directed to the [BARE Discord](https://discord.gg/sbgdcdv).
...
### What version of BARE Core are you using?
