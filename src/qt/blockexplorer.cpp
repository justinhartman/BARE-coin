...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            ...
            QMessageBox::warning(this, "BARE Coin Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f7f7f8; bgcolor:#9b0000;}\n a, span { font-family: monospace; }\n span.addr {color:#843534; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #843534;}\n td.d0 {font-weight: bold; color:#f7f7f9;}\n h2, h3 { white-space:nowrap; color:#843534;}\n a { color:#f7f7f9; text-decoration:none; }\n a.nav {color:#333333;}\n";
