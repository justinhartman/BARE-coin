...
The BARE Coin project has been designed to support multiple localisations. This makes adding new phrases, and completely new languages easily achievable. For managing all application translations, BARE Coin makes use of the Transifex online translation management tool.
...
The BARE Coin translation maintainers include *Fuzzbawls and s3v3nh4cks*. You can find them, and others, in the [BARE Slack](https://bare.slack.com).
